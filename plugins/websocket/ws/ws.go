...
import (
	...
	//"github.com/Allenxuxu/goreaction"
...
type Upgrader struct {
	...
	ProtocolCustom func(*goreaction.Connection, []byte) (string, bool)
	...
	ExtensionCustom func(*goreaction.Connection, []byte, []httphead.Option) ([]httphead.Option, bool)
	...
	OnRequest func(c *goreaction.Connection, uri []byte) error
	...
	//
	// RejectConnectionError could be used to get more control on response.
	OnHost func(c *goreaction.Connection, host []byte) error
	...
	//
	// RejectConnectionError could be used to get more control on response.
	OnHeader func(c *goreaction.Connection, key, value []byte) error
	...
	//
	// RejectConnectionError could be used to get more control on response.
	OnBeforeUpgrade func(c *goreaction.Connection) (header HandshakeHeader, err error)
}
...
func (u *Upgrader) Upgrade(c *goreaction.Connection, in *ringbuffer.RingBuffer) (out []byte, hs Handshake, err error) {
	...
	case bytesToString(req.method) != http.MethodGet:
